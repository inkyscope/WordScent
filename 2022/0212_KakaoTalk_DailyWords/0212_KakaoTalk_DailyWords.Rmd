---
title: "0212KakaoTalk daily words "
author: "Sung Inkyung"
date: '2022 2 12'
...
Psalms 90:14 Satisfy us in the morning with your unfailing love, that we may sing for joy and be gald all our days
...
label_segments <- tibble(
  ...
  x = df$id * 15,
  xend = x + 6 * rep(c(1, -1), length.out = 4),
  y = 1,
  yend = 1 * rep(c(0.7, 1.3), length.out = 4),
...
plot <-  
  ...
  labs(title = "Daily Bread from Mrs. Yoon MinSook",
       subtitle = "Excerpts of the words that were repeated 4 times among the daily\nbible messages that Mrs.Yoon sent through KakaoTalk since 2019",
       caption = "Source: KakaoTalk from Mrs.Yoon | Graphic: Sung Inkyung") +
  theme_void() +
