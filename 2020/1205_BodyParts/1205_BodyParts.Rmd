...
plot <- bodyparts%>% 
  ...
  geom_text(aes(x = "hand", y = 300, label = "300"), hjust = -1.6, size = 2) +
  geom_text(aes(x = "hand", y = 600, label = "600"), hjust = -2.6, size = 2) +
  geom_text(aes(x = "hand", y = 900, label = "900"), hjust = 3.7, size = 2) +
  geom_text(aes(x = "hand", y = 1200, label = "1200"), hjust = 2.3, size = 2) +
...
ggsave(here::here("2020", "1205_BodyParts", "1205_BodyParts.png"), width = 34, height = 20, units = "cm")
```
