...
net_plot <- df_preposition %>% 
  ...
  labs(title = "Preposition Pairs Network",
       subtitle = "**god**, **faith** and **righteousness** are core words linked to selected prepositions most repeatedly",
  ...
  theme(panel.background = element_rect(fill = "#3a425d"),
        ...
        plot.subtitle = element_markdown(color = "gray75",
                                         size = 16,
                                         hjust = .5,
                                         margin = margin(b = 15)),
        plot.caption = element_markdown(color = "gray75",
                                    hjust = 1,
                                    margin = margin(t = 30, b = 20)),
        plot.margin = margin(20, 60, 10, 20))

ggsave(here::here("2020", "1205_PrepositionsPairs", "1205_PrepositionsPairsNetwork.png"), width = 28, height = 18, units = "cm")
```
