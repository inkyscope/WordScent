...
tree_plot <- book_by_characters %>% 
  ...
  geom_treemap_text(color = "white",
                    ...
                    reflow = T,
                    size = 13) +
  labs(title = "Biblw Books by Number of Characters",
       subtitle = "Of the New Testament Gospels, Luke, Acts, Matthew are listed in the top 20",
...
ggsave(here("M2020", "0711_BibleTreemap", "BibleBooksTreemap.png"), width = 12, height = 10, units = "cm")
```
