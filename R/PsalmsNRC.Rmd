...
base_plot <- plot_sent %>% 
  ...
  labs(x = "",
       y = "Percent of words",
       title = "Psalms sentiment flow from chapter 1 to chapter 150",
       subtitle = ("Using NRC lexicon, it divides into the category of the sentiments \nassociated with words in Psalms across chapters."),
       caption = "visualization by sung inkyung | source: kingjamesbibleonline.org") +
...
ggsave(here("figures", "PsalmsSentimentFlowBasePlot.png"), width = 13, height = 9, units = "in")
```
...
animate(animation, width = 850, height = 450, 
        ...
        fps = 20, 
        end_pause = 20,
        renderer = gifski_renderer(here::here("figures", "PsalmsSentimentFlow.gif")))
```
