...
tf_idf_plot <- top_tf_idf %>% 
  ...
  labs(x = " ",
       y = " ",
       title = "Top 20 tf_idf words in 4 gospels",
       subtitle = "Words are stacked by tf_idf from top to bottom.\nThe point of tf_idf statistics is intended to identify how importatn a word is to a each book.\nTF_IDF refers to term frequency_inverse term frequency",
...
ggsave(here("figures", "MatthewMarkLukeJohn.png"), width = 24, height = 11, units = "cm")
