---
title: "Words Net of Characters in Job"
author: "Sung Inkyung"
date: '2020 6 21 '
...
net_plot <- job_words %>% 
  ...
  geom_node_text(
    ...
    color = "white",
    repel = T) +
  scale_color_manual(values = c("#5e86bd", "#df5286", "#db6565", "#307a49", 
                                "#d6b354",  "#7ed1f2", "#9e155e")) +
  labs(title = "Word Network by Characters\nin the Book of Job",
...
ggsave(here("figures", "WordsNetinJob.png"), width = 28, height = 18, units = "cm")
