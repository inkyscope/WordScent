...
job_words <- job %>%
   mutate(
    ...
    chapter %in% c("3", "6", "7", "9", "10", "12", "13", "14", "16", "17", "19", "21", "23", "24", "26", "27", "28", "29", "30", "31", "40", "41") ~ "Job",
...
ggraph(layout) +
  ...
  coord_fixed() +
  labs(
    title = "Characters connected to 300 Words through 42 Chapters of Job",
  ...
  theme(
    ...
    plot.subtitle = element_text(
      face = 'plain', hjust = 0.5, size = 13, 
      margin = margin(t = 5, b = 3)),
    plot.caption = element_text(
      face = 'plain', color = '#dedede', 
      size = 8, hjust = 1,
      margin = margin(b = 20)
    )
  )

ggsave(here("figures", "PersonaCirclesinJob.png"))
```
