...
wordpillar_plot <- Psalms_books %>% 
  ...
  labs(
    ...
    subtitle = "Based on a sentiment analysis of Psalms, each word from Book 1 to Book 5 shows top 50 words<br>by contribution value to each book,either in a <span style='color:#006b38ff'>positive</span> or in a <span style='color:#755139ff'>negative</span> way.<br>The size of each word indicates its contribution per book.</span>",
...
ggsave(here("figures", "PsalmsPillars.png"), width = 37, height = 40, units = "cm")
```
