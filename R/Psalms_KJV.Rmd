...
p1 <- not_words %>% 
  ...
  labs(title = "Words preceded by 'not' based on \nthe contribution to sentiment values",
       x = " ",
...
p2 <- word_cors %>% 
  ...
  coord_flip() +
  labs(title = "Most correlated words with selected words:<br><span style = 'color:#66C2A5'>**Enemy**</span>, <span style = 'color:#FC8D62'> **Mercy**</span>, <span style = 'color:#8DA0CB'> **Mouth**</span>, <span style = 'color:#E78AC3'> **Word**</span>",
       x = "",
       y= "correlation") +
  theme_half_open(12) +
...
p3 <- word_cors %>%  
  ...
  labs(title = "Pairwise correlation in <span style = 'color:#1caa55'>**Psalms**</span>",
       subtitle = "Correlated words appearing within the same 10-line verses.<br>What's recognized is a cluster related to **Word** on the bottom left.",
       caption =  "source | King James version") +
...
ggsave(here("figures", "psalms_scroll.png"), width = 11, height = 7, units = "in")
