...
p3 <- word_cors %>%  
  ...
  labs(title = "Correlated Word Pairings in <span style = 'color:#210070'>**Psalms**</span>",
       subtitle = "Correlated words with higher than .25 correlation appearing within the same 10-line verses.<br>What brought to my attention is a cluster related to **word** on the bottom left such as precepts, statutes, commandments,<br>judgments,law, and testimonies.",
...
ggsave(here("figures", "psalms_scroll.png"), width = 14, height = 13, units = "in")
