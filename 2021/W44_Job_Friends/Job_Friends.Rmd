...
plot <- df %>% 
  ...
  annotate("text", x = -0.15, y = 27.5, 
           label = "More Job", angle = 90, 
           color = pal[1],  fontface = "bold", size = 9) +
  annotate("text", x = 0.15, y = 5, 
           label = "More His Friends", angle = 270, 
           color = pal[2],  fontface = "bold", size = 9) +
  #caption
  annotate("text", x = -0.48, y = 12.5, 
...
ggsave(here::here("2021", "W44_Job_Friends", "Job_Friends.png"), width = 30, height = 35, units = "cm")
```