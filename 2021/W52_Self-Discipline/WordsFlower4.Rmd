...
```{r}
word_oct <- c("gather", "venture", "entwine", "vindicate", "shape", "distinguish", "silence", "prompt")
...
paletteer_d("tvthemes::FireNation")
cols_nov <- c("#ECB100FF", "#A10000FF", "#7E605EFF", "#FF4500FF", "#994823FF", "#4B4C4EFF", "#572530FF", "#000000FF")
...
```{r}
final <- plot_oct|plot_nov|plot_dec

ggsave(here::here("2021", "W52_Self-Discipline", "2021_WordFlower4.png"), dpi = 300, width = 45, height = 15, units = "cm")
