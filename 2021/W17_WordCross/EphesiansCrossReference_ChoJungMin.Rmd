...
plot_eph <- visNetwork(nodes, links, width = "100%", height = "900px",
                      ...
                      submain = list(text = "It was about how to live as a chuch with EPHESIANS delivered by Pastor Cho Jung Min<br>between 2020.11.22 and 2021.3.7 for 16weeks at Basic Church in Seoul Korea.<br>Paster Cho's Sermons have the beauty of crisscrossing Bible.",
