...
plot <- job_friends %>% 
  ...
  labs(title = "Sentiment Analysis of <span style = 'color:#229900'>POSITIVE</span> and <span style = 'color:#ff6161'>NEGATIVE</span>",
       subtitle = "Illusttraed below Words appeared more than 2 times between<br>Job and his friends(Eliphaz, Bildad and Zophar",
...
ggsave(here::here("2021", "W49_JobFriends_PosNeg", "Job_Friends_Sentiment.png"))
