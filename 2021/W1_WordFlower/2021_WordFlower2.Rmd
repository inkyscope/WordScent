...
cols_apr <- c("#98D880FF", "#68B078FF", "#88C5A1FF", "#508858FF", "#405040FF", "#F8E820FF", "#D0D018FF", "#A8C040FF")
...
plot_final <- plot &
 ...
 ggsave(here::here("2021", "W1_WordFlower", "2021_WordFlower2.png"), dpi = 300, width = 45, height = 15, units = "cm")
```
