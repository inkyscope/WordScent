...
plot_may <- 
  ...
  coord_equal() +
  theme_void() +
  theme(plot.background = element_rect(fill = "#c36902",
                                       color = NA),
        panel.background = element_rect(fill = "#c36902",
                                       color = NA))
```
...
plot_jun <- 
  ...
  coord_equal() +
  theme_void() +
  theme(plot.background = element_rect(fill = "#ff7986",
                                       color = NA),
        panel.background = element_rect(fill = "#ff7986",
                                       color = NA),)
```
