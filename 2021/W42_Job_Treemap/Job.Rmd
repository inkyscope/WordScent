...
ggplot(df, aes(chapter, n, fill = word)) +
  ...
  geom_text(aes(label = word, size = n *pi),
            ...
            check_overlap = TRUE,
            color = "gray10") +
  scale_x_continuous(breaks = seq(1, 42, 3)) +
  scale_fill_viridis_d(begin = 0.01, end = 0.95, option = "C") +
  scale_size_continuous(range = c(0.4, 5)) +
  coord_cartesian(expand = FALSE,
                  clip = "off") +
  labs(title = "Words from Job",
...
ggsave(here::here("2021", "W42_Job_Treemap", "Job.png"), width = 15, height = 11, units = "cm")
