...
ggplot(grid_words) +
  ...
  labs(
    title = "1 Samuel Related Top Words",
  ...
  theme(
    ...
    plot.subtitle = element_text(color = c1, 
                                 size = 20),
    plot.caption = element_text(color = c1, 
                                size = 12, hjust = 0.5),
    plot.margin = margin(20, 20, 20, 20)
  )

ggsave(here::here("2021", "W38_1Samuel", "1Samuel_TopLogOdds.png"), width = 25, height = 25, units = "cm")
```
