...
paletteer_d("ggthemes::Nuriel_Stone") ##april_colors
cols_apr <- c("#8175AAFF", "#6FB899FF", "#31A1B3FF", "#CCB22BFF", "#A39FC9FF", "#94D0C0FF", "#959C9EFF", "#027B8EFF", "#9F8F12FF")
...
paletteer_d("palettetown::electrike") ##june_colors
cols_jun <- c("#98D880FF", "#68B078FF", "#181818FF", "#508858FF", "#405040FF", "#F8E820FF", "#D0D018FF", "#A8C040FF")
