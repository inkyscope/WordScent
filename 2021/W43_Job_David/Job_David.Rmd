...
plot1 <- df_tf_idf %>% 
  ...
  theme(legend.position = "none",
        plot.background = element_rect(fill = "#fbe9c3",
                                       color = NA),
        ...
        strip.text.x = element_text(size = 12,
                                    face = "bold", 
                                    colour = "#3e445e"),
        plot.margin = margin(20,20,30,30))

plot1

ggsave(here::here("2021", "W43_Job_David", "Job_David.png"), dpi = 300, width = 24, height = 16, units = "cm")
```
...
```
        ...
        title = "<span style = 'color:#4288ae'>**More from David**</span> and <span style ='color:#15404e'>**More from Job**</span>",
...
ggsave(here::here("2021", "W43_Job_David", "Job_David_Ratios.png"), dpi = 300, width = 28, height = 24, units = "cm")
